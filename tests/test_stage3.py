...
STAGE3 = os.path.join(REPO_ROOT, "vendor", "palisade", "bin", "stage3")
PROBE_DIR = os.path.join(REPO_ROOT, "vendor", "palisade", "tests", "probes")
...
class TestNoEarlyReturnStructurally(unittest.TestCase):
    ...
    def test_no_early_return_structurally(self):
        stage3_src = os.path.join(REPO_ROOT, "vendor", "palisade", "src", "palisade", "stage3.c")
