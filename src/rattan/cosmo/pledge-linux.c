...
#endif                             //
    /* rattan: read-only xattr queries (coreutils ls -l / id use these to
     * detect ACLs & security labels). Read-only metadata — no sandbox
     * surface added beyond what stat/readdir already expose. */
    __NR_linux_getxattr,           //
    __NR_linux_lgetxattr,          //
    __NR_linux_fgetxattr,          //
    __NR_linux_listxattr,          //
    __NR_linux_llistxattr,         //
    __NR_linux_flistxattr,         //
};
